...
namespace StackExchange.Opserver.Controllers
{
    public partial class WebServerController : StatusController
    {
        ...
        {
            //var aa = DashboardCategory.AllCategories.FirstOrDefault(x => x.Name == "Web Servers Recuper@").Nodes;
        ...
        [Route("webserver/node/summary/{type}")]
        ...
        [Route("webserver/graph/{nodeId}/{type}")]
        [Route("webserver/graph/{nodeId}/{type}/{subId?}")]
